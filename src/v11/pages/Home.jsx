...
const HERO_IMAGES = [
  { id:'poultry', label:'Poultry',  url:'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=500&q=70', link:'/v1-1/species#poultry' },
  { id:'cow',     label:'Cow',      url:'https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?w=500&q=70', link:'/v1-1/species#dairy' },
  { id:'buffalo', label:'Buffalo',  url:'https://images.unsplash.com/photo-1741387863358-0421a7e5a085?w=500&q=70', link:'/v1-1/species#dairy' },
];
  ...
  return (
    <main className="home" style={{position:"relative"}}>
      ...
      <nav className="species-bar">
        {[
          {id:'poultry',label:'Poultry',icon:'🐓',link:'/v1-1/species#poultry'},
          {id:'cow',label:'Cow',icon:'🐄',link:'/v1-1/species#dairy'},
          {id:'buffalo',label:'Buffalo',icon:'🦬',link:'/v1-1/species#dairy'},
        ].map(s=>(
      ...
      <section className="home-about">
        <div className="home-about-inner">
          <div className="home-about-text">
            ...
            <Link to="/v1-1/company" className="btn-outline">Learn More →</Link>
          </div>
      ...
      <section className="home-products">
            ...
            <div className="solutions-half-content">
              ...
              <div className="solutions-cards">
                {PRODUCTS.filter(p=>p.species.includes('poultry')).map(p=>(
                  <Link to={`/v1-1/products/${p.id}`} key={p.id} className="sol-card">
        ...
        <div className="home-products-cta">
          <Link to="/v1-1/products" className="btn-primary">View All Products →</Link>
        </div>
      </section>
      ...
      <section className="home-cta">
        <div className="home-cta-inner">
          ...
          <Link to="/v1-1/contact" className="btn-white">Contact Our Team →</Link>
        </div>
      </section>
    </main>
  );
