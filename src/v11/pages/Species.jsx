            ...
            <div className="sp-inner">
              ...
              <div className="sp-content">
                ...
                <div className="sp-prods">
                  ...
                  {prods.map(p=><Link to={`/v1-1/products/${p.id}`} key={p.id} className="sp-pl"><span className="sol-plus">+</span><div><span className="spn">{p.name}</span><span className="sps">{p.subtitle}</span></div></Link>)}
                </div>
              </div>
            </div>
          </section>
