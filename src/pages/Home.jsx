...
const HERO_IMAGES = [
  ...
  { id:'cow',     label:'Cow',      url:'https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?w=500&q=70', link:'/species#dairy' },
  { id:'buffalo', label:'Buffalo',  url:'https://images.unsplash.com/photo-1741387863358-0421a7e5a085?w=500&q=70', link:'/species#dairy' },
];
