    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          <Logo size="sm" white />
          <p className="footer-address">Berg + Schmidt India Pvt. Ltd.<br/>A subsidiary of Berg + Schmidt International GmbH<br/>Pune, Maharashtra, India</p>
        </div>
        <div className="footer-col"><h4>Poultry</h4><ul>
        ...
        <div className="footer-col"><h4>Dairy</h4><ul>
        ...
        <div className="footer-col"><h4>Legal</h4><ul>
      ...
      <div className="footer-bottom">© {new Date().getFullYear()} Berg + Schmidt India Pvt. Ltd. All rights reserved.</div>
    </footer>
  );
}
