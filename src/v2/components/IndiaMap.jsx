...
/* Corporate palette only — Brand Codes Documentation p.8 (web-team feedback:
   "please use the corporate colours listed below"). No off-brand amber/slate. */
const C_HEAD_OFFICE = '#5769A9'; // Accent 1  — Berg + Schmidt India HQ (not HEF)
const C_HEF = '#004C3E';         // Green 2   — Hightech Energy Feeds plants
const C_DAIRY = '#4CB496';       // Green 1   — dairy feed supplement representatives
const C_POULTRY = '#E32653';     // Red 1     — poultry feed supplement representatives
...
export default function IndiaMap() {
  ...
  const handleEnquire = (m) => {
    ...
    navigate(`/v2/contact?${params.toString()}#contact-form`);
  };
